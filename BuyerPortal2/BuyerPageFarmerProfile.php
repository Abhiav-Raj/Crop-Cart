                        ...
                        <div class="row">
                            <div class="col-md-12" style="margin-top:35px;">
                                <span style="padding:15px;">
                                    <h4 id="full_name" class=""><img src="iconsmall.png" style="width: 28px; margin-bottom:  10px;"><b>Abhinav Raj</b></h4>
                                </span>
                                <span style="padding:15px;">
                                    <h4 id="full_name" style="margin-left:-9%;"><img src="phoneicon.jpg" style="width: 32px; margin-bottom:  10px;"><b> 7033395280 </b></h4>
                                </span>
                                <span style="padding:15px;">
                                    <h4 id="full_name" class=""><img src="location.jpg" style="width: 32px; margin-bottom:  10px;"><b> Bihar , Nalanda</b></h4>
                                </span>
                            </div>
                        </div>
					</div>
               ...
               <div class="container">
                    ...
                    <div class="row">
                         <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center">
                              <p><u><a href="https://www.cropcart.com/">cropcart Corporation</a></u> is a Multitrading Company for farmers ang traders</p>
